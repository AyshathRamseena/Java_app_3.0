...
def jfrogUpload() :
    ...
    url = "http://18.235.255.178:8082/artifactory/example-repo-local/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar"
    file_path = "/home/ubuntu/JFrog/target/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar"
    username = 'admin'
